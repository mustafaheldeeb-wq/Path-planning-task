...
_SCENARIOS: Dict[str, Tuple[List[Cone], CarPose]] = {
    ...
    "21": ( # A sharp right turn with multiple cones
        [
            Cone(x=2.0, y=3.0, color=1),
            Cone(x=3.0, y=4.0, color=1),
            Cone(x=1.0, y=1.0, color=0),
        ...
        CarPose(x=0.0, y=0.0, yaw=0.8), # Car starts angled towards the turn
    ),

    "22": ( # A long, sweeping left turn
        [
    ...
    "23": ( # An immediate, tight slalom-like gate
        [
            Cone(x=1.0, y=2.0, color=1),
            Cone(x=1.0, y=-1.0, color=0),
        ],
        CarPose(x=0.0, y=0.0, yaw=0.0), # Car starts pointing straight at the gate
    ),
